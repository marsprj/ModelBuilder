var CorrelationDiffDetectionDialog = function(inputs,outputs,parms,onOk){
	this._funName = "CorrelationDiffDetection";
	FunDialog.apply(this, arguments);
}

extend(CorrelationDiffDetectionDialog, FunDialog);

CorrelationDiffDetectionDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			+'<div class="titlebar">'
			+'	<div class="dialog_title">基于相关系数的变化检测</div>'
...
CorrelationDiffDetectionDialog.prototype.verify = function(){
