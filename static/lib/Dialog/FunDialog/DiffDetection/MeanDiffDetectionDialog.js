var MeanDiffDetectionDialog = function(inputs,outputs,parms,onOk){
	this._funName = "MeanDiffDetection";
	FunDialog.apply(this, arguments);
}

extend(MeanDiffDetectionDialog, FunDialog);


MeanDiffDetectionDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			+'<div class="titlebar">'
			+'	<div class="dialog_title">平均变化检测</div>'
...
MeanDiffDetectionDialog.prototype.verify = function(){
