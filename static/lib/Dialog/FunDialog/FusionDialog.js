...
FusionDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			...
			+'		<div class="f-left item-title">全色图像:</div>'
			...
			+'	</div>'
			+'	<div class="dialog_item">'
			+'		<div class="f-left item-title">多光谱图像:</div>'
			+'		<div class="f-left item-content">'
			+'			<div class="f-left item-input">'
			+'				<input type="text" class="dialog-input">'
			+'			</div>'
			...
			+'		<div class="f-left item-content">'
			+'			<select class="parms f-left" parm="method">'
			+'			</select>'
			+'		</div>'
			+'	</div>'
			+'</div>'
...
FusionDialog.prototype.setParms = function(parms){
	if(!parms){
		return;
	}
...
FusionDialog.prototype.getParms = function(){
	var parms = [];
