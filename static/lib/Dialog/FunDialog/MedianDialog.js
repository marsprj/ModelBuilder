var MedianDialog = function(){
	this._funName = "MedianImageFilter";
	FunDialog.apply(this, arguments);
}

extend(MedianDialog,FunDialog);

MedianDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			+'<div class="titlebar">'
			+'	<div class="dialog_title">中值滤波</div>'
