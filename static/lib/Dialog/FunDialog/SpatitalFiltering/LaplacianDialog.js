var LaplacianDialog = function(){
	this._funName = "Gradient";
	FunDialog.apply(this, arguments);
}

extend(LaplacianDialog, FunDialog);

LaplacianDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			+'<div class="titlebar">'
			+'	<div class="dialog_title">拉普拉斯滤波</div>'
