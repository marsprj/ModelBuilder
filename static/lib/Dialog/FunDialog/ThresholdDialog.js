...
ThresholdDialog.prototype.create = function(){
	var html =   '<div class="func_dialog dialog">'
			...
			+'				<div class="f-left item-title">下限：</div>'
			+'				<input type="text" class="f-left parms" parm="lower">'
			+'			</div>'
			+'			<div class="f-left upper-div">'
			+'				<div class="f-left item-title">上限：</div>'
			+'				<input type="text" class="f-left parms" parm="upper">'
			+'			</div>'
			+'		</div>'
			+'	</div>'
			+'	<div class="dialog_item">'
			...
			+'				<div class="f-left item-title">阈值内：</div>'
			+'				<input type="text" class="f-left parms" parm="inside">'
			+'			</div>'
			+'			<div class="f-left outside-div">'
			+'				<div class="f-left item-title">阈值外：</div>'
			+'				<input type="text" class="f-left parms" parm="outside">'
			+'			</div>'
			+'		</div>'
			+'	</div>'
			+'</div>'
