...
extend(Erode, FuncNode);

Erode.prototype.export = function(){
	var obj = {
		id : this.getID(),
		name : this._name,
		inputs : [
...
Erode.prototype.onClick = function(isPathEdit){
	var inputs = [];
	var output;
	$(".tooltip").remove();
	if(this._inputs){
	...
	var parms = [];
	var dlg = new ErodeDialog(inputs, output,parms, function(){	//onOK
