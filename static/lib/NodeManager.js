...
NodeManager.prototype.createFuncNode = function(type, r, xmin, ymin, width, height, round){
	...
	switch(type){
		...
		break;
		case FUNCTION_TYPE.RadioLineDetector:{
			node = new RadioLineDetector(r, xmin, ymin, width, height, round);
		}
		break;
		...
		break;
		case FUNCTION_TYPE.ConnectedSegment:{
			node = new ConnectedSegment(r, xmin, ymin, width, height, round);				
		}
		break;
